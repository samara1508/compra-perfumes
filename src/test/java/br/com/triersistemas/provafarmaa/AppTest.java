...
public class AppTest {
    ...
    public void classPerfumeTest() {
        var p1 = new Perfume("p1", BigDecimal.ONE, TipoPerfume.EAU_DE_PARFUM);
        var p2 = new Perfume("p2", BigDecimal.TEN, TipoPerfume.EAU_DE_TOILETTE);
